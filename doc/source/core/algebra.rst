...
algebra operations, such as calculating the norm of a vector, computing inner
product of vectors, performing matrix vector operations, etc.
...
.. cpp:class:: algebra.h
   ...
   .. cpp:function:: double norm(Vector& x)
      ...
      Calculate the :math:`\ell_2` norm of vector x.
